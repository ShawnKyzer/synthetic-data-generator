...
# synthetic_data_pipeline documentation build
...
from synthetic_data_pipeline import __version__ as release
...
htmlhelp_basename = "synthetic_data_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "synthetic_data_pipeline.tex",
        "synthetic_data_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "synthetic_data_pipeline",
        "Project synthetic_data_pipeline codebase.",
        "Data-Science",
    )
]
